        ...
        <div class="col-md-3">
          ...
          <div class="box box-danger sombra">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Cristhian Alberto Hernández Moreno</h3>
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="<?=$GLOBALS['COD']->dir?>/assets/dist/img/photo1.png" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="<?=$GLOBALS['COD']->dir?>/assets/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="<?=$GLOBALS['COD']->dir?>/assets/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="<?=$GLOBALS['COD']->dir?>/assets/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="<?=$GLOBALS['COD']->dir?>/assets/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
